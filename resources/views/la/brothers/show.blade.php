...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $brother->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Brothers", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/brothers/'.$brother->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Brothers", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.brothers.destroy', $brother->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/brothers') }}" data-toggle="tooltip" data-placement="right" title="Back to Brothers"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'brother_id')
						@la_display($module, 'avatar')
						@la_display($module, 'name')
						@la_display($module, 'phi_name')
						@la_display($module, 'bio')
						@la_display($module, 'phone')
						@la_display($module, 'personal_email')
